...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: '菜鸟工具箱',
        desc: '开发人员必备的在线工具箱',
        link: 'https://c.runoob.com/front-end/61/'
      },
      {
        icon: '../.vitepress/public/images/favicon/json.cn.ico',
        title: 'Json 中文网',
        desc: 'JSON 在线解析及格式化验证',
        link: 'https://www.json.cn'
      },
      {
        icon: 'https://www.cssnano.cn/img/favicon.ico',
        title: 'CSSNANO 中文网',
        desc: 'CSS 在线优化及格式化工具',
        link: 'https://www.cssnano.cn/playground'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'http://expressjs.com/images/favicon.png',
        title: 'Express.js',
        desc: '基于 Node.js 的快速、简洁的 web 框架',
    ...
    items: [
      {
        ...
        desc: 'Leaflet 是最著名的前端地图可视化库，它开源、体积小、结构清晰、简单易用',
        link: 'https://leafletjs.com/'
      },
      {
        icon: 'https://developers.arcgis.com/favicon.ico',
        title: 'ArcGIS API for JS',
        desc: 'ArcGIS API for JS 是较为学院派的前端地图库,它不开源且收费不低，在学术场景下较为常用。',
        link: 'https://developers.arcgis.com/javascript/latest/'
      },
      {
        title: 'Openlayers',
        icon: 'https://openlayers.org/favicon.ico',
        desc: 'Openlayers 也是常用的前端地图库，它开源，相比于Leaflet更加复杂和完备',
        link: 'https://openlayers.org/'
      },
      {
        title: 'Cesium',
        icon: 'https://www.cesium.com/cesium-logomark.svg',
        desc: 'Cesium 是三维地理可视化的常用库，在大尺度的可视化（地形、建筑、地球）中十分常用',
        link: 'https://www.cesium.com/'
      },
      {
        title: '百度地图 JS API /百度地图 API GL',
        icon: 'https://lbsyun.baidu.com/favicon.ico',
        desc: '百度地图 JS API 是传统的二维地图，百度地图 API GL 是三维地图，它们依赖百度地图提供的后台服务。除了地图服务外还有检索、导航、实时交通等关联服务。开发者有免费的限额。',
      ...
      },
      {
        ...
        desc: 'AntV L7 是空间数据可视化库，它可以使用高德地图等协作构建地图可视化。',
